    ...
    <div className="min-h-screen">
          ...
          <div className="text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl sm:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                ...
                <br />
                <span className="text-blue-400 font-semibold">Crypto payments • Instant delivery • Secure licensing</span>
              </p>
            </div>
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4">
              Why Choose <span className="text-blue-400">theDBot</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center space-y-4 p-6 rounded-2xl bg-gray-800/50 hover:bg-gray-800/70 transition-all duration-300">
              ...
              <p className="text-gray-300">Download and install in minutes. No complex configuration required.</p>
            </div>
            ...
            <div className="text-center space-y-4 p-6 rounded-2xl bg-gray-800/50 hover:bg-gray-800/70 transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-white">Secure Licensing</h3>
              <p className="text-gray-300">One license per account. Advanced protection against unauthorized use.</p>
            </div>
            ...
            <div className="text-center space-y-4 p-6 rounded-2xl bg-gray-800/50 hover:bg-gray-800/70 transition-all duration-300">
              ...
              <p className="text-gray-300">Backtested strategies with real market performance data.</p>
            </div>
            ...
            <div className="text-center space-y-4 p-6 rounded-2xl bg-gray-800/50 hover:bg-gray-800/70 transition-all duration-300">
              ...
              <p className="text-gray-300">24/7 customer support and regular updates for all platforms.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-6xl px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4">
              Trading <span className="text-blue-400">Categories</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900/50 to-purple-900/50">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">
            Ready to Start <span className="text-blue-400">Automated Trading</span>?
          </h2>
