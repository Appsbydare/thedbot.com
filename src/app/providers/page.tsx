  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Important Notice */}
        <div className="mb-8 rounded-xl p-6 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800">
          <h2 className="text-lg font-semibold text-yellow-900 dark:text-yellow-300 mb-2">Important Notice</h2>
          <ul className="list-disc list-inside text-sm text-yellow-900/80 dark:text-yellow-200 space-y-1">
            <li>Signal providers are independent third parties.</li>
            <li>theDBot does not guarantee provider performance and is not responsible for trading losses.</li>
            <li>We provide software tools only, not financial advice. Test signals on demo first.</li>
            <li>Past performance does not guarantee future results.</li>
          </ul>
        </div>
        {/* Header */}
        <div className="text-center mb-12">
          <h1 className="text-4xl font-heading text-gray-900 dark:text-white mb-4">
            Signal Providers
          </h1>
